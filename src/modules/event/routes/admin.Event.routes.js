...
router.route('/')
  ...
  .post(setSection('events'), upload.fields([{ name: 'image_url', maxCount: 1 }]), controller.create);
...
router.route('/:id')
  ...
  .put(setSection('events'), upload.fields([{ name: 'image_url', maxCount: 1 }]), controller.update)
